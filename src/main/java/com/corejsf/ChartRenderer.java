...
@FacesRenderer(componentFamily="javax.faces.Output" , rendererType="com.corejsf.Chart")
public class ChartRenderer extends Renderer {
	...
	public void encodeBegin(FacesContext context, UIComponent component)
		...
		writer.writeAttribute("src", url + "?" + BinaryPhaseListener.DATA_ID_PARAM + "=" + id, null);
